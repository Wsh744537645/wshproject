...
App.constant('APP_COLORS', {
    ...
    modules: [
      	{name: 'toaster',                   files: ['js/vendor/angularjs-toaster/toaster.js',
                                                 'js/vendor/angularjs-toaster/toaster.css']},
      	{name: 'localytics.directives',     files: ['js/vendor/chosen_v1.2.0/chosen.jquery.min.js',
                                                 'js/vendor/chosen_v1.2.0/chosen.min.css',
                                                 'js/vendor/angular-chosen-localytics/chosen.js']},
      	{name: 'ngDialog',                  files: ['js/vendor/ngDialog/js/ngDialog.min.js',
                                                 'js/vendor/ngDialog/css/ngDialog.min.css',
                                                 'js/vendor/ngDialog/css/ngDialog-theme-default.min.css'] },
      	{name: 'ngWig',                     files: ['js/vendor/ngWig/dist/ng-wig.min.js'] },
      	{name: 'ngTable',                   files: ['js/vendor/ng-table/dist/ng-table.min.js',
                                                  'js/vendor/ng-table/dist/ng-table.min.css']},
      	{name: 'ngTableExport',             files: ['js/vendor/ng-table-export/ng-table-export.js']},
      	{name: 'angularBootstrapNavTree',   files: ['js/vendor/angular-bootstrap-nav-tree/dist/abn_tree_directive.js',
                                                  'js/vendor/angular-bootstrap-nav-tree/dist/abn_tree.css']},
      	{name: 'htmlSortable',              files: ['js/vendor/html.sortable/dist/html.sortable.js',
                                                  'js/vendor/html.sortable/dist/html.sortable.angular.js']},
      	{name: 'xeditable',                 files: ['js/vendor/angular-xeditable/dist/js/xeditable.js',
                                                  'js/vendor/angular-xeditable/dist/css/xeditable.css']},
      	{name: 'angularFileUpload',         files: ['js/vendor/angular-file-upload/angular-file-upload.js']},
      	{name: 'ngImgCrop',                 files: ['js/vendor/ng-img-crop/compile/unminified/ng-img-crop.js',
                                                  'js/vendor/ng-img-crop/compile/unminified/ng-img-crop.css']},
      	{name: 'ui.select',                 files: ['js/vendor/angular-ui-select/dist/select.js',
                                                  'js/vendor/angular-ui-select/dist/select.css']},
      	{name: 'ui.codemirror',             files: ['js/vendor/angular-ui-codemirror/ui-codemirror.js']},
      	{name: 'angular-carousel',          files: ['js/vendor/angular-carousel/dist/angular-carousel.css',
                                                  'js/vendor/angular-carousel/dist/angular-carousel.js']},
      	{name: 'ngGrid',                    files: ['js/vendor/ng-grid/build/ng-grid.min.js',
                                                  'js/vendor/ng-grid/ng-grid.css' ]},
      	{name: 'infinite-scroll',           files: ['js/vendor/ngInfiniteScroll/build/ng-infinite-scroll.js']},
      	{name: 'ui.bootstrap-slider',       files: ['js/vendor/seiyria-bootstrap-slider/dist/bootstrap-slider.min.js',
                                                  'js/vendor/seiyria-bootstrap-slider/dist/css/bootstrap-slider.min.css',
                                                  'js/vendor/angular-bootstrap-slider/slider.js']},
      	{name: 'ui.grid',                   files: ['js/vendor/angular-ui-grid/ui-grid.min.css',
                                                  'js/vendor/angular-ui-grid/ui-grid.min.js']},
      	{name: 'textAngularSetup',          files: ['js/vendor/textAngular/src/textAngularSetup.js']},
      	{name: 'textAngular',               files: ['js/vendor/textAngular/dist/textAngular-rangy.min.js',
                                                  'js/vendor/textAngular/src/textAngular.js',
                                                  'js/vendor/textAngular/src/textAngularSetup.js',
                                                  'js/vendor/textAngular/src/textAngular.css'], serie: true},
      	{name: 'angular-rickshaw',          files: ['js/vendor/d3/d3.min.js',
                                                  'js/vendor/rickshaw/rickshaw.js',
                                                  'js/vendor/rickshaw/rickshaw.min.css',
                                                  'js/vendor/angular-rickshaw/rickshaw.js'], serie: true},
      	{name: 'datatables',                files: ['js/vendor/datatables/media/css/jquery.dataTables.css',
                                                  'js/vendor/datatables/media/js/jquery.dataTables.js',
                                                  'js/vendor/angular-datatables/dist/angular-datatables.js'], serie: true},
      	{name: 'angular-jqcloud',           files: ['js/vendor/jqcloud2/dist/jqcloud.css',
                                                  'js/vendor/jqcloud2/dist/jqcloud.js',
                                                  'js/vendor/angular-jqcloud/angular-jqcloud.js']},
      	{name: 'ng-nestable',               files: ['js/vendor/ng-nestable/src/angular-nestable.js',
                                                  'js/vendor/nestable/jquery.nestable.js']},
      	{name: 'akoenig.deckgrid',          files: ['js/vendor/angular-deckgrid/angular-deckgrid.js']}
    ]
});
...
App.controller('SidebarController', ['$rootScope', '$scope', '$state', '$http', '$timeout', 'Utils',
  function($rootScope, $scope, $state, $http, $timeout, Utils){
    ...
    $scope.loadSidebarMenu = function() {
      	$http.get(mpoolUI_url + '/sys/menu/menus' + '?v=' + (new Date().getTime()))
