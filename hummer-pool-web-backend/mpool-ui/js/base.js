    ...
    function ngModule($provide) {
      ...
      $provide.provider('$compile', $CompileProvider).
        directive({
            ...
            ngRepeat: ngRepeatDirective,    //有用
            ngShow: ngShowDirective, //用户名称展示处
            ngTransclude: ngTranscludeDirective,  //左边栏
...
angular.module("ui.bootstrap", ["ui.bootstrap.tpls","ui.bootstrap.position","ui.bootstrap.dropdown","ui.bootstrap.tooltip"]);
