...
@Service
public class PhoneCodeCahceServiceImpl implements PhoneCodeCahceService {

	private static final Logger log = LoggerFactory.getLogger(PhoneCodeCahceServiceImpl.class);
	...
	private final String PREFIX = "SHARE_PHONE_";

	@Override
	public String getCode(String key) {

		Object object = redisTemplate.opsForValue().get(PREFIX + key);
		log.debug("PhoneCodeCacheService get -> {} ,value -> {}", PREFIX + key, object);
		if (object != null) {
	...
	public void putCode(String key, String value) {
		log.debug("PhoneCodeCacheService set -> {}", PREFIX + key + ":" + value + ":" + second);
