...
import com.mpool.share.config.shiro.ShiroFormAuthenticationFilter;
import com.mpool.share.config.shiro.cache.RedisShiroSessionDAO;
import com.mpool.share.config.shiro.realm.TelphoneRealm;
import com.mpool.share.config.shiro.realm.UsernamePasswordRealm;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
		...
		filterMap.put("/apis/product/**", "anon");

		filterMap.put("/dashbaord/**", "anon");
		filterMap.put("/apis/dashbaord/**", "anon");

		filterMap.put("/order/**", "anon");
		filterMap.put("/apis/order/**", "anon");

		filterMap.put("/bill/**", "anon");
		filterMap.put("/apis/bill/**", "anon");
