...
import com.mpool.pool.config.ZecCanalConfig;
...
//@Component
//@Order(2)
public class ZecSyncServiceV2Impl extends SyncServiceResolverV2 implements CommandLineRunner {
	...
	private static final Logger log = LoggerFactory.getLogger(ZecSyncServiceV2Impl.class);

	@Autowired
	private JavaMailSender javaMailSender;
	@Autowired
	@Qualifier("zecWorkerServiceImpl")
	public WorkerService workerService;
	@Autowired
	public ZecCanalConfig canalConfig;
