...
public enum ExceptionCode {
	...
	user_not_exists("user.not.exists", "用户不存在"),
	balance_not_enough("user.balance.not.enough", "用户余额不足"),
	txid_exists("txid.exists","TXID已存在"),
	bill_not_exists("bill.not.exists","账单不存在"),
	bill_state_error("bill.state.error","账单状态错误"),
	product_not_exists("product.not.exists","商品不存在"),
