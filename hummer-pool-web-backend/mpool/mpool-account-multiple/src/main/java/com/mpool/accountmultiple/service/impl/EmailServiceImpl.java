...
import com.mpool.accountmultiple.mapper.EmailLogMapper;
import com.mpool.accountmultiple.service.EmailService;
import com.mpool.accountmultiple.utils.RequestResolveUtil;
...
public class EmailServiceImpl implements EmailService {
	...
	public void sendSimple(String to, String title, String content) {
		...
		try {
			...
			throw new AccountException("email.sent.fail", "邮件发送失败！");
		}
