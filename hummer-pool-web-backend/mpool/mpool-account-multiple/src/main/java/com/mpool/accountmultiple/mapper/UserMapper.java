...
import com.mpool.mpoolaccountmultiplecommon.model.subaccount.SubAccountList;
...
public interface UserMapper extends BaseMapper<User> {
	 ...
	 * @return
	 */
	IPage<SubAccountList> findUserByMaster(IPage<SubAccountList> page, @Param("user") User userParam);

	User findById(@Param("userId") Long userId);

	IPage<User> selectUserPageByPayCurrencyId(IPage<User> iPage, @Param("masterId") Long masterId, @Param("currencyId") int currencyId);
}
